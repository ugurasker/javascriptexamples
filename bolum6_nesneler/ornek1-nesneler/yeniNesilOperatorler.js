...
//! DEstructring kullanilirken "key" isimleri nesneninki 
//ile ayni olmalidir, aksi takdirde undefined degerler doner.

const {ad,konum,email} = birey; // birey nesnesindeki
//propertyleri ayristirir.
console.log(ad,konum,email);
birey.ad="Mustafa";// birey nesnesindeki adi gunceller.
console.log(birey);
